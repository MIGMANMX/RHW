<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="EMasivaPJ.aspx.vb" Inherits="EMasivaPJ" %>
     ...
     <style type="text/css">
      ...
      <div id="contenedor">
        ...
        <asp:GridView ID="GridView1" runat="server" 
            DataKeyNames ="idpartidas_jornada" AutoGenerateColumns="False" CellPadding="4" 
            ForeColor="#333333" GridLines="None" Width="632px" Height="92px" AllowPaging="True" AllowSorting="True" PageSize="15" CssClass="auto-style14">
            <Columns>
               ...
               <asp:TemplateField>
                ...
                <asp:BoundField DataField="fecha" HeaderText="Fecha" SortExpression="fecha" HtmlEncode="False" DataFormatString = "{0:d}"/>
                 <asp:CheckBoxField DataField="completar" HeaderText="Entrada" />
                 <asp:CheckBoxField DataField="completarfin" HeaderText="Salida" />
                 <asp:CheckBoxField DataField="completarhsal" HeaderText="HSalida" />
        ...
        <asp:TextBox ID="grdSR" runat="server" Visible="false"></asp:TextBox>         
                 ...
                 <td class="auto-style6">
                     ...
                     <br />
                    <asp:TextBox ID="fecha" runat="server" CssClass="txtCaptura" MaxLength="40" Width="69px" Enabled="False" Visible="False" />                              
                     <br />
                     <br />
                     <br />
                     <br />
