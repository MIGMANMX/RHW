...
Partial Class AuPrestamos
        ...
        For Each row As GridViewRow In GridView1.Rows
            ...
            If row.RowType = DataControlRowType.DataRow Then
                ...
                If chkRow.Checked Then
                    ...
                    Dim r As String = ap.actualizarPrestamoCHK(row.Cells(1).Text, True)
                    GridView1.DataSource = ap.gvPrestamoCHK(wucSucursales.idSucursal, TxFechaInicio.Text, TxFechaFin.Text)
                    ap = Nothing
                    GridView1.DataBind()
                    ...
                    'grdSR.Text = gvp.seleccionarGridRow2(GridView1, row.Cells(1).Text)
        ...
        For Each row As GridViewRow In GridView1.Rows
            ...
            If row.RowType = DataControlRowType.DataRow Then
                ...
                If chkRow.Checked Then
                    ...
                    Dim ap As New ctiCalendario
                    Dim r As String = ap.actualizarPrestamoCHK(row.Cells(1).Text, False)
                    GridView1.DataSource = ap.gvPrestamoCHK(wucSucursales.idSucursal, TxFechaInicio.Text, TxFechaFin.Text)
                    ap = Nothing
                    GridView1.DataBind()
                    If r.StartsWith("Error") Then
    ...
    Protected Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click
        ...
        GridView1.DataSource = gvds.gvPrestamoCHK(wucSucursales.idSucursal, TxFechaInicio.Text, TxFechaFin.Text)
