<%@ Page Title="" Language="VB" MasterPageFile="~/Principal.master" AutoEventWireup="false" CodeFile="RepValesRH.aspx.vb" Inherits="RepValesRH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="left">
        <table class="auto-style3">
            <tr>
                <td class="auto-style1" style="height: 59px" id="suc" runat="server">Sucursal:<br />
            ...
            <tr>
                <td class="auto-style12">Fecha Inicio:<br />
                    <asp:TextBox ID="TxFechaInicio" runat="server" MaxLength="40" Width="100px" CssClass="txtCaptura" Enabled="False" />
                ...
                <td class="auto-style2" style="height: 59px">
            ...
            <tr>
                <td class="auto-style25" style="height: 153px" >
        ...
        <rsweb:ReportViewer ID="Repo" runat="server" Font-Names="Verdana" Font-Size="8pt" Height="395px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1005px">
            <LocalReport ReportPath="ReportValesRH.rdlc">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DataSet1" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="nomRHDataSetTableAdapters.vm_Vales_RHTableAdapter">
            <SelectParameters>
