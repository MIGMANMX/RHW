...
Partial Class _RegistroIncidenciasAvisos
    ...
    Protected Sub wucEmpleados_empleadoSeleccionada(sender As Object, e As System.EventArgs) Handles wucEmpleados2.empleadoSeleccionado
        ...
        GridView1.DataSource = gvds.gvAsigIncidenciasAvisos(wucEmpleados2.idEmpleado)
    ...
    Protected Sub btnGuardarNuevo_Click(sender As Object, e As EventArgs) Handles btnGuardarNuevo.Click
        ...
        If fecha.Text <> "" And wucEmpleados2.idEmpleado <> 0 And wucSucursales.idSucursal <> 0 And TxObservaciones.Text <> "" Then
            ...
            Dim r() As String = gp.agregarAsigIncidenciasAvisos(1009, wucEmpleados2.idEmpleado, fecha.Text, TxObservaciones.Text)
            GridView1.DataSource = gc.gvAsigIncidenciasAvisos(wucEmpleados2.idEmpleado)
            gc = Nothing
            GridView1.DataBind()
    ...
    Protected Sub btnActualizarr_Click(sender As Object, e As EventArgs) Handles btnActualizarr.Click
        ...
        If fecha.Text <> "" And wucEmpleados2.idEmpleado <> 0 And wucSucursales.idSucursal <> 0 And TxObservaciones.Text <> "" Then
            ...
            Dim r As String = ap.actualizarAsigIncidenciasAvisos(idA, 1009, wucEmpleados2.idEmpleado, fecha.Text, TxObservaciones.Text)
            GridView1.DataSource = ap.gvAsigIncidenciasAvisos(wucEmpleados2.idEmpleado)
            ap = Nothing
            GridView1.DataBind()
            ...
            Else
                btnActualizarr.Enabled = False
                btnGuardarNuevo.Enabled = True
                fecha.Text = "" : wucEmpleados2.idEmpleado = 0 : wucSucursales.idSucursal = 0 : TxObservaciones.Text = ""
                FechaC.SelectedDates.Clear()
            End If
            gvp = Nothing
            Lmsg.Text = r
    ...
    Protected Sub GridView1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GridView1.RowCommand
        ...
        ElseIf e.CommandName = "Editar" Then
            ...
            Dim datos() As String = dsP.datosAsigIncidenciasAvisos(CInt(GridView1.Rows(Convert.ToInt32(e.CommandArgument)).Cells(2).Text))
            dsP = Nothing
